        ...
        <main className="min-h-screen bg-[#0B0C15] selection:bg-emerald-500/30 text-white relative pb-20">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="text-center mb-8 sm:mb-10 px-2">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-blue-500">
                        Dual N-Back
                    </h1>
                ...
                <div className="mt-16 sm:mt-24 max-w-4xl mx-auto px-2 sm:px-0">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12">
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 backdrop-blur-sm">
                            <div className="flex items-center gap-3 mb-3 sm:mb-4 text-emerald-400">
                                <Eye className="w-6 h-6" />
                                <h3 className="text-lg sm:text-xl font-bold text-white">Position Task</h3>
                            </div>
                            <p className="text-slate-300 mb-5 sm:mb-6 leading-relaxed text-sm sm:text-base">
                                A square will appear on the grid. Remember its position. If the square appears in the{" "}
                                <strong>same spot</strong> as it did 2 turns ago, it's a match.
                            </p>
                            <div className="bg-black/20 rounded-xl p-4 font-mono text-xs sm:text-sm text-center border border-white/5">
                                <div className="flex justify-center gap-2 text-slate-500 mb-2 text-[11px] sm:text-xs uppercase tracking-widest">
                                    Example Sequence
                                </div>
                                ...
                                <div className="mt-2 text-emerald-400 text-[11px] sm:text-xs font-bold">MATCH!</div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 backdrop-blur-sm">
                            <div className="flex items-center gap-3 mb-3 sm:mb-4 text-blue-400">
                                ...
                                <h3 className="text-lg sm:text-xl font-bold text-white">Audio Task</h3>
                            </div>
                            <p className="text-slate-300 mb-5 sm:mb-6 leading-relaxed text-sm sm:text-base">
                            ...
                            <div className="bg-black/20 rounded-xl p-4 font-mono text-xs sm:text-sm text-center border border-white/5">
                                ...
                                <div className="mt-2 text-blue-400 text-[11px] sm:text-xs font-bold">MATCH!</div>
                            </div>
                        </div>
                    </div>

                    <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 border border-white/10 rounded-2xl p-5 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                            <div className="p-3 bg-white/5 rounded-xl">
                                <Keyboard className="w-6 h-6 text-slate-400" />
                            </div>
                            <div>
                                <h4 className="text-white font-bold text-base sm:text-lg">Pro Tip: Use Keyboard</h4>
                                <p className="text-slate-400 text-xs sm:text-sm">It's faster than clicking.</p>
                            </div>
                        </div>

                        <div className="flex gap-3 sm:gap-4 w-full md:w-auto justify-center">
                            <div className="flex items-center gap-2 sm:gap-3 bg-black/20 px-4 py-2 rounded-lg border border-white/5">
                                <span className="font-bold text-white text-sm sm:text-base">L</span>
                                <span className="text-slate-500 text-xs sm:text-sm">for Position</span>
                            </div>
                            <div className="flex items-center gap-2 sm:gap-3 bg-black/20 px-4 py-2 rounded-lg border border-white/5">
                                <span className="font-bold text-white text-sm sm:text-base">A</span>
                                <span className="text-slate-500 text-xs sm:text-sm">for Audio</span>
                            </div>
                        </div>
                    </div>
                </div>
